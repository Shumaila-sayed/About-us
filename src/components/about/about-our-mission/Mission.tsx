...
export default function Mission() {
	return (
		<section className='bg-white py-12 px-6 text-center'>
			<h2 className='text-3xl inline md:text-4xl font-bold text-[#2C2C2C] '>
				{missionData.aboutOurMission.sectionHeading}
			</h2>
			<h3 className='text-3xl inline md:text-4xl text-[#2C2C2C] '>
				{missionData.aboutOurMission.subHeading}
			</h3>
			<p className='text-gray-600 max-w-4xl mx-auto text-base md:text-lg leading-relaxed mb-4 mt-8'>
			...
			<p className='text-gray-600 max-w-4xl mx-auto text-base md:text-lg leading-relaxed mb-4'>
				{missionData.aboutOurMission.subParagraph}
			</p>
